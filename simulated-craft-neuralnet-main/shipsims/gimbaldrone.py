# This file creates the definition of the gimbaldrone class with its functions as well as the Thruster class:
# __Init__: create a drone
# end_trial: destroys self
# check_for_goal: compares current position of self to position of the goal and increments time touching goal
# update: updates the drone at the tickrate desired           ???
# update_parts: updates self                 ???
# draw: draws the drone to the display
# status: returns self.active, self.time_in, self.time_out, self.goal_counter, self.closest_to_goal
# get_inputs: 
# set_controls: 
# Thruster class has teh following functions:
# __init__:
# update: updates the thrusters angle adn thrust
# get_angle: returns self.angle of the thruster
# draw: draws the thruster to the display
